...
export const metadata: Metadata = {
  ...
  description:
    'Rencontrez Aphrody, le Maître du Jeu de la République Populaire du Beyblade.',
};
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <Box>
              ...
              >
                ...
                >
                  Gardien des tournois, arbitre suprême de la RPB et architecte
                  du destin de chaque Blader. Aphrody veille sur la méta
                  Beyblade X avec une précision chirurgicale.
                </Typography>
                <Box sx={{ mt: 3, display: 'flex', gap: 2 }}>
                  <Box sx={{ textAlign: 'center', flex: 1 }}>
                    <Typography variant="h6" fontWeight="900" color="#fbbf24">
                      LVL 99
                    </Typography>
