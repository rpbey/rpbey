...
import { getRPBStreamInfo, getLatestRPBVideo } from '@/lib/twitch'
import { headers } from 'next/headers'
import { LiveTv, Radio, History, YouTube as YouTubeIcon } from '@mui/icons-material'
...
export default async function TVPage() {
  ...
  return (
    <Container maxWidth="xl" sx={{ py: 4 }}>
            ...
            <Card sx={{ borderRadius: 4, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', bgcolor: 'surface.low' }}>
                <CardContent sx={{ textAlign: 'center' }}>
                    {streamInfo?.isLive ? (
                        ...
                        <>
                            <History sx={{ fontSize: 48, mb: 1, color: 'text.secondary' }} />
      ...
      <Box sx={{ display: { xs: 'flex', sm: 'none' }, justifyContent: 'center', mb: 4 }}>
        <Button 
          variant="contained" 
          color="error" 
          fullWidth
