      ...
      <Grid container spacing={4}>
        <Grid size={{ xs: 12, md: 8 }}>
          ...
          <Paper elevation={0} sx={{ borderRadius: 4, border: '1px solid', borderColor: 'divider', mb: 4, overflow: 'hidden' }}>
              ...
              <Stack spacing={3} sx={{ mt: 3 }}>
                <Stack direction="row" spacing={2}>
                  ...
                  <Box>
                    ...
                    <Typography variant="body1">Dimanche 11 janvier 2026</Typography>
                  </Box>
                </Stack>
                ...
                <Stack direction="row" spacing={2}>
                  ...
                  <Box>
                    <Typography variant="subtitle1" fontWeight="bold">Heure</Typography>
                    <Typography variant="body1">Début à 14h00 (Ouverture des inscriptions/check-in à 13h00)</Typography>
                  </Box>
                </Stack>
                ...
                <Stack direction="row" spacing={2}>
                  ...
                  <Box>
                    <Typography variant="subtitle1" fontWeight="bold">Lieu</Typography>
                    <Typography variant="body1">Dernier Bar Avant la Fin du Monde, 19 Avenue Victoria, 75001 Paris</Typography>
                  </Box>
                </Stack>
                ...
                <Stack direction="row" spacing={2}>
                  ...
                  <Box>
                    <Typography variant="subtitle1" fontWeight="bold">Format</Typography>
                    <Typography variant="body1">3on3 classique en Double éliminations (pas de Ban-list ou de limited-list pour le moment)</Typography>
                  </Box>
                </Stack>
              </Stack>
            </Box>
            ...
            {/* Map */}
            <Box sx={{ height: 400, width: '100%', borderTop: '1px solid', borderColor: 'divider' }}>
               <Map position={mapPosition} popupText={tournament.location || "Lieu du tournoi"} />
            </Box>
          </Paper>
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          {/* Actions Card */}
          <Paper elevation={0} sx={{ p: 3, borderRadius: 4, border: '1px solid', borderColor: 'divider', position: 'sticky', top: 100 }}>
            <Typography variant="h6" fontWeight="bold" gutterBottom>
              Inscription
            </Typography>
            <Typography variant="body2" color="text.secondary" paragraph>
              Pour participer, assure-toi d'être inscrit sur Challonge et d'avoir rejoint notre serveur Discord.
            </Typography>
