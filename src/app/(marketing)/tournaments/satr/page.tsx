  ...
  return (
    <Container maxWidth="lg" sx={{ py: { xs: 1, md: 2 } }}>
      ...
      >
        ...
        {/* Center: Search */}
        <Box sx={{ flex: 2, width: '100%', maxWidth: 500 }}>
          <Suspense
            fallback={
              <Paper
                sx={{ height: 40, width: '100%', bgcolor: 'action.hover' }}
              />
            }
          >
              ...
              <Tooltip key={s.name} title={s.name}>
                <IconButton
                  ...
                  sx={{
                    ...
                    '&:hover': { color: s.color, bgcolor: 'action.hover' },
                  }}
                >
      ...
      {lastUpdate?.updatedAt && (
        <Typography
          variant="caption"
          color="text.secondary"
          sx={{ display: 'block', mb: 1, px: 1, fontStyle: 'italic' }}
        >
          Dernière mise à jour : {lastUpdate.updatedAt.toLocaleString('fr-FR')}
        </Typography>
      )}
