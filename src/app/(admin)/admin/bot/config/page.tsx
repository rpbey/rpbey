    ...
    <Box sx={{ p: 3 }}>
      ...
      >
        ...
        <Stack direction="row" spacing={1}>
          <Tooltip
            title={showSecrets ? 'Masquer les secrets' : 'Afficher les secrets'}
          >
      ...
      <Alert severity="info" sx={{ mb: 3 }}>
        Cette page affiche la configuration actuelle du bot. Les modifications
        doivent être faites via les fichiers de configuration et nécessitent un
        redémarrage du bot.
      </Alert>
