...
export function ProfileSettingsForm() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      setMessage({ type: 'success', text: 'Image téléchargée. Cliquez sur Enregistrer pour valider.' });
    } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (email !== session?.user.email) {
          ...
          setMessage({ type: 'success', text: 'Profil mis à jour. Un email de vérification a été envoyé pour la nouvelle adresse.' });
      } else {
